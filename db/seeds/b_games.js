  ...
  return knex('games').del()
    .then(function () {
      return Promise.all([
        ...
        knex('games').insert({location: '567 Hoops Blv', start_time: '2017-04-20T19:00:00', end_time: '2017-04-20T20:00:00', equipment: false, description: 'We still need gatorade', number_of_players: 6, title: '4-4 Basketball'})
      ]);
    });
};
